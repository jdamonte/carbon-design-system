...
var ragCellClassRules = {
  'rag-green-outer': function ragGreenOuter(params) {
    return params.value === 2008;
  },
  'rag-amber-outer': function ragAmberOuter(params) {
    return params.value === 2004;
  },
  'rag-red-outer': function ragRedOuter(params) {
...
var columnDefs = [{
  ...
  cellStyle: {
    ...
    backgroundColor: '#D7E7BD' // light green
